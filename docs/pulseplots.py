...
def plot_eod_deletion():
	...
	for i, fname in enumerate(fnames):
		...
		sb.xscalebar(ax,1,0,max(1,int(250*len(mean_eod)/samplerate)),ha='right',wunit='ms')
		ax.axis('off')
		...
		sb.xscalebar(ax,1,0,max(1,int(250*len(ex_mean_eod)/samplerate)),ha='right',wunit='ms')
		ax.axis('off')
