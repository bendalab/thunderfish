...
jan@aeshna:~/prj/thunderfish > ls docs/
collectfish.md  eodexplorer.md  index.md  spatialpoisson.ipynb  thunderfish.md
jan@aeshna:~/prj/thunderfish > thunderfish --help
