...
- [`fishfinder`](https://bendalab.github.io/thunderfish/api/fishfinder.html): Browse EOD recordings and detect EOD frequencyies on the fly.
- [`thunderfish`](https://bendalab.github.io/thunderfish/thunderfish.html): Automatically detect and analyze all EOD waveforms in short recordings and generate summary plots and data tables.
- [`collectfish`](https://bendalab.github.io/thunderfish/collectfish.html): Collect data generated by thunderfish.
- [`eodexplorer`](https://bendalab.github.io/thunderfish/eodexplorer.html/): View and explore properties of EOD waveforms.
- [`thunderbrowse`](https://bendalab.github.io/thunderfish/api/thunderbrowse.html): Browse multi-channel EOD recordings.
- [`thunderlogger`](https://bendalab.github.io/thunderfish/api/thunderlogger.html): extract EOD waveforms from logger recordings.
