...
- *thunderfish*: Automatically detect and analyze all fish present in a short EOD recording and generate a summary plot and data tables. [Read documentation](doc/thunderfish.md).
