...
from thunderlab.powerspectrum import add_spectrum_config
...
from .waveanalysis import add_extract_wave_config, add_analyze_wave_config
...
from .eodanalysis import add_eod_analysis_config, add_eod_quality_config
...
def configuration():
    ...
    cfg.add('minPSDAverages', 3, '', 'Minimum number of fft averages for estimating the power spectrum.')  # still needed by fishfinder
