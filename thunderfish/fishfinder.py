...
cfg.add('maxPeakWidthFac', 3.5, '', 'Maximum width of peaks at 0.75 hight in multiples of frequency resolution (might be increased)')
...
cfg.add('freqTolerance', 0.7, '', 'Harmonics need be within this factor times the frequency resolution of the power spectrum. Needs to be higher than 0.5!')
cfg.add('maxUpperFill', 1, '', 'As soon as more than this number of harmonics need to be filled in conescutively stop searching for higher harmonics.')
cfg.add('maxFillRatio', 0.25, '', 'Maximum fraction of filled in harmonics allowed (usefull values are smaller than 0.5)')
...
cfg.add('minimumGroupSize', 3, '', 'Minimum required number of harmonics (inclusively fundamental) that are not filled in and are not used by other groups.')
...
cfg.add('maximumWorkingFrequency', 4000.0, 'Hz', 'Maximum frequency to be used to search for harmonic groups and to adjust fundamental frequency.')
