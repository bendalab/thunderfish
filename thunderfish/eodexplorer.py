...
class PrintHelp(argparse.Action):
    def __call__(self, parser, namespace, values, option_string):
        ...
        print('p,P                     toggle between data columns, PC, and scaled PC axis')
        print('<, pageup               decrease number of displayed data columns/PC axis')
        ...
        print('left, right, up, down   show and move magnified scatter plot')
        print('escape                  close magnified scatter plot')
        parser.exit()      
