...
def generate_wavefish(freq, samplerate, time_len=20., harmonics=5):
...
if __name__ == '__main__':
    ...
    # generate_pulsefish(80., samplerate)
    wavefish = generate_wavefish(300., samplerate)
