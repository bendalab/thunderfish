...
def generate_wavefish(frequency=100.0, samplerate=44100.0, duration=1.0, phase0=0.0,
                      noise_std=0.05, amplitudes=1.0, phases=0.0):
    """
...
def generate_alepto(frequency=100.0, samplerate=44100.0, duration=1.0,
                    phase0=0.0, noise_std=0.01):
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        wavefish = generate_wavefish(eodf, samplerate, duration=duration, noise_std=0.02, 
                                     phase0=0.0, amplitudes=[1.0, 0.5, 0.1, 0.0001],
        ...
        # chirps:
        chirps_freq = chirps(600.0, samplerate, duration=duration)
