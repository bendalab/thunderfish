...
def plot_freq_histogram(m1, m2, m3, m4, s1, s2, s3, s4, x_label, x_limits, binwidth, savefig=False,
                        save_path_and_name='./histo_fig.pdf'):
...
if __name__ == '__main__':
    ...
    plot_freq_histogram(df_m1, df_m2, df_m3, df_m4, df_s1, df_s2, df_s3, df_s4, 'Beat Frequencies', binwidth=20,
                        x_limits=[-1000, 1000])
